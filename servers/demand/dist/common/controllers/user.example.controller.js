...
const user_example_model_1 = __importDefault(
...
class UserController {
    ...
    constructor() {
        ...
        this.router.post(
            '/',
            validation_middleware_1.default.validate(
                user_example_dto_1.default
            ),
            (0, catch_error_1.default)(this.createUser)
        )
        // extract 1 param example
        this.router.param(
            'id',
            validation_middleware_1.default.extractParams(['id'])
        )
        // cache example
        ...
        this.router.get(
            '/details/:id/:idx',
            validation_middleware_1.default.extractParams(['id', 'idx']),
            (0, catch_error_1.default)(this.getUser)
        )
        // upload file example
        const multercloud = new multer_1.default(
            ['jpg', 'jpeg', 'png', 'gif'],
            5 * 1024 * 1024
        )
        this.router.post(
            ...
            (0, catch_error_1.default)(this.uploadFile)
        )
    }
    createUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = yield jwt.createToken(userInfo, {
            ...
            const token2 = yield jwt_1.default.createToken(userInfo, {
                expiresIn: process.env.JWT_REFRESH_EXPIRES,
            })
            logger_1.default.info(token2)
            const payload2 = yield jwt_1.default.verifyToken(token2)
            logger_1.default.info(payload2)
            // sendmail example
    ...
    getUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            // test extract params
            logger_1.default.info(req.body.id)
            logger_1.default.info(req.body.idx)
            req.user = {
            ...
            yield redisClient === null || redisClient === void 0
                ? void 0
                : redisClient.setEx(
                      UserController.profileCacheKey(req),
                      Number(process.env.REDIS_CACHE_EXPIRES),
    ...
    uploadFile(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.default.info(req.cloudinaryResult)
