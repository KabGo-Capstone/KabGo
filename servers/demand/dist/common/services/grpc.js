...
class GrpcServer {
    ...
    loadProtos() {
        const packageDefinition = (0, proto_loader_1.loadSync)(path_1.default.join(__dirname, '../../../protos/demand.proto'));
        const customersProto = (0, grpc_js_1.loadPackageDefinition)(packageDefinition);
    ...
    start() {
        ...
        this.server.bindAsync(`0.0.0.0:${(_a = process.env.gRPC_PORT) !== null && _a !== void 0 ? _a : 50051}`, credentials, () => {
            var _a;
            this.server.start();
            logger_1.default.info(chalk_1.default.green(`gRPC server is running on port ${chalk_1.default.cyan((_a = process.env.gRPC_PORT) !== null && _a !== void 0 ? _a : 50052)}`));
        });
    }
    stop() {
