...
const credential_middleware_1 = __importDefault(
    require('./middlewares/credential.middleware')
)
...
class Application {
    ...
    setup() {
        ...
        this.app.use(
            (0, morgan_1.default)(
                `${chalk_1.default.blue(this.appName)}${chalk_1.default.yellow('[:date]')} ${chalk_1.default.green(':method')} ${chalk_1.default.cyan(':status')} ${chalk_1.default.white(':url')} :res[content-length] - :response-time ms`
            )
        )
        ...
        mongoose_1.default
            ...
            .then(() => {
                logger_1.default.info(
                    chalk_1.default.green('Connected to database successfully')
                )
            })
            .catch((error) => {
    ...
    redisConnect(uri) {
        redis_1.default
            ...
            .then(() => {
                logger_1.default.info(
                    chalk_1.default.green('Connected to redis successfully')
                )
            })
            .catch((error) => {
    ...
    run(callback = () => {}) {
        ...
        const availablePort =
            (_a = process.env.APP_PORT) !== null && _a !== void 0 ? _a : 3000
        const server = this.app.listen(availablePort, () =>
            __awaiter(this, void 0, void 0, function* () {
                logger_1.default.info(
                    chalk_1.default.green(
                        `Server is running on port ${chalk_1.default.cyan(availablePort)}`
                    )
                )
                ...
                io.on('connection', (socket) => {
                    logger_1.default.info(
                        `Connection details - Socket ID: ${socket.id}`
                    )
