...
class GrpcServer {
    ...
    loadProtos() {
        const packageDefinition = (0, proto_loader_1.loadSync)(path_1.default.join(__dirname, '../../../protos/supply.proto'));
        const driversProto = (0, grpc_js_1.loadPackageDefinition)(packageDefinition);
        const { service } = driversProto.DriverInfomations;
